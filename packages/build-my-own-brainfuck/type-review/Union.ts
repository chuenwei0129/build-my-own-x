...
type IfNever<T = never> = T extends number ? true : false
type IfAny<T = any> = T extends number ? true : false
type IfUnion<T> = T extends number ? true : false

// never
type TestIfNever = IfNever<never>
// boolean
type TestIfAny = IfAny<any>
// boolean
type TestIfUnion = IfUnion<1 | '2'>
// false
type TestUnionLiteral = 1 | '2' extends number ? true : false
